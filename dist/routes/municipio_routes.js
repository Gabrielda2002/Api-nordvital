...
router.put("/update-status-municipio/:id", auth_1.authenticate, (0, authorize_roles_1.authorizeRoles)(['1']), validar_id_1.validarId, municipio_controller_1.updateStatusMunicipio);
