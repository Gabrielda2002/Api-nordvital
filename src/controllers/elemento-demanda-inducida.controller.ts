...
export const getAllElementDemandInduced = async (req: Request, res: Response, next: NextFunction) => {
    try {
...
export const getElementDemandInducedByName = async (req: Request, res: Response, next: NextFunction) => {
    try {
        ...
        const elementDemandInduced = await ElementoDemandaInducida.createQueryBuilder("elemento")
