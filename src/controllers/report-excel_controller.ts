...
export async function downloadReportExcel(
  ...
  try {
    ...
    worksheet.columns = [
      ...
      { header: "Descripción Diagnóstico", key: "Descripcion_diagnostico", width: 30 },
      ...
      { header: "Fecha Actualización CUPS", key: "Fecha_actualizacion", width: 20 },
      { header: "Observación Seguimiento Auxiliar", key: "Observacion_seguimiento_auxiliar", width: 30 },
      { header: "Fecha Registro Seguimiento", key: "Fecha_registro", width: 20 },
