...
export async function getRegisterEntriesByDocument( req: Request, res: Response, next: NextFunction ){
    try {
        ...
        if (dateStart && dateEnd) {
            query.andWhere('registro_entrada.registerDate >= :dateStart', {dateStart})
