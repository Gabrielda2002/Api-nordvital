...
export const getDepartmentUser = async (req: Request, res: Response, next: NextFunction) => {
    try {
    ...
    req.departmentUserId = user.sedeRelation?.municipioRelation.departmentRelation?.id;
