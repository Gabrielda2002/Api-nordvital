...
export async function create(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const exist = await AreaDependencia.createQueryBuilder("a")
        ...
        const newArea = await AreaDependencia.create({
            name: name
        });
...
export async function update(req: Request, res: Response, next: NextFunction) {
    try {
        ...
        const exist = await AreaDependencia.findOneBy({ id: parseInt(id as string) });
