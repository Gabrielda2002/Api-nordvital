...
@Entity({ name: "sst_attachments" })
export class SstAttachment extends BaseEntity {
    ...
    @ManyToOne(() => SstTicket, (ticket) => ticket.attachmentsRelation)
    @JoinColumn({ name: "ticket_id" })
    ticketRelation: SstTicket;

    @ManyToOne(() => Usuarios, (usuario) => usuario.sstAttachmentsRelation)
