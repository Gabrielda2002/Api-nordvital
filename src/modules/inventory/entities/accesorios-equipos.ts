...
import { MaintenanceAccessoryObservation} from "./maintenance-accessory-observation";
...
export class AccesoriosEquipos extends BaseEntity {
  ...
  @Length(3, 255, {
    message:
      "El nombre del accesorio debe tener entre $constraint1 y $constraint2 caracteres",
  })
  name: string;
  ...
  @Length(2, 255, {
    message:
      "La marca del accesorio debe tener entre $constraint1 y $constraint2 caracteres",
  })
  brand: string;
  ...
  @Length(3, 255, {
    message:
      "El serial del accesorio debe tener entre $constraint1 y $constraint2 caracteres",
  })
  serial: string;
  ...
  @Length(3, 255, {
    message:
      "Los otros datos del accesorio deben tener entre $constraint1 y $constraint2 caracteres",
  })
  otherData: string;
  ...
  @Length(3, 255, {
    message:
      "El estado del accesorio debe tener entre $constraint1 y $constraint2 caracteres",
  })
  status: string;
  ...
  @Length(3, 255, {
    message:
      "El número de inventario del accesorio debe tener entre $constraint1 y $constraint2 caracteres",
  })
