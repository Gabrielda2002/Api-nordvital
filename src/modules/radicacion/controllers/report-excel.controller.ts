...
import { getReportSurgerysRows } from "../../surgeries/services/report-surgerys.service";
import { getReportAssistantsRows } from "../../hr/services/report-assistants.service";
import { getReportBreakesActiveRows } from "../../hr/services/report-breakes-active.service";
import { getReportBiometricRows } from "../../hr/services/report-biometric.service";
import { getReportTicketsRows } from "../../tickets/services/report-tickets.service";
import { getReportDemandInducedRows } from "../../demand-induced/services/report-demand-induced.service";
import { getReportEquipmentsRows } from "../../inventory/services/report-equipments.service";
import { getReportRedDeviceRows } from "../../inventory/services/report-red-device.service";
import { getReportGeneralInventoryRows } from "../../inventory/services/report-general-inventory.service";
import { getReportTVRows } from "../../inventory/services/report-tv.service";
import { getReportPhonesRows } from "../../inventory/services/report-phones.service";
...
export async function getReportDemandInduced(
  ...
  try {
    ...
    worksheet.columns = [
      ...
      { header: "", key: "headquarter", width: 30 },
    ];
