 ...
 */
router.post("/patient", authenticate, authorizeRoles(['1', '3', '10', '15', '6',  '19', '20', '21']), createPatient);
 ...
 *         description: Paciente no encontrado
 */
router.post("/pacientes-documento", authenticate, authorizeRoles(['1', '3', '10', '15', '6',  '19', '20', '21']), getPacientesByDocument);
 ...
 *         description: Paciente no encontrado
 */
router.put("/table/patient/:id", authenticate, authorizeRoles(['1', '2', '3', '5']), validarId, updatePacienteTable);
