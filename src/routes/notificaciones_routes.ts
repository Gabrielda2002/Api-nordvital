 ...
 */
router.get('/notifications/user/:userId', authenticate, authorizeRoles(['1']), getUserNotifications);
 ...
 */
router.put('/notifications/:id/read', authenticate, authorizeRoles(['1']), markNotificationAsRead);
