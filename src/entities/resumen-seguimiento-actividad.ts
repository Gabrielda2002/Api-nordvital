...
@Entity({ name: "resumen_seguimiento_actividad" })
export class ResumenSeguimientoActividad extends BaseEntity {
    ...
    @IsString()
    @IsNotEmpty({ message: "El nombre del resumen es requerido" })
    ...
    // Relaciones
    @OneToMany(() => DemandaInducida, (demandaInducida) => demandaInducida.resumenRelation)
