...
export class SeguimientoDispositivosRed extends BaseEntity {
    ...
    @Length(10, 255, {message: 'El tipo de evento debe tener entre 10 y 255 caracteres'})
    eventType: string

    @Column({name: 'descripcion'})
    @IsString()
    @IsNotEmpty({message: 'La descripción es requerida'})
    @Length(10, 255, {message: 'La descripción debe tener entre 10 y 255 caracteres'})
    description: string
    ...
    @ManyToOne(() => dispositivosRed, device => device.seguimientoDispositivosRedRelation)
