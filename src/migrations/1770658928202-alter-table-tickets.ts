...
export class AlterTableTickets1770658928202 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        // ? agregar columna en la tabla tickets tipo de tipo enum con los valores "Solicitud" ,"Incidente", "Problema", "Cambio" y "Otro"
        await queryRunner.addColumn("tickets", new TableColumn({
            name: "tipo",
            type: "enum",
            enum: ["Solicitud", "Incidente", "Problema", "Cambio", "Otro"],
            default: "'Solicitud'",
        }));
    }
